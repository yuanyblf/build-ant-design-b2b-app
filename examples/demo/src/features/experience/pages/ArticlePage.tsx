...
const articles: Article[] = [
  { id: 1, title: '把工作日过成有能量的一天', summary: '从午间散步、专注休息到下班运动，分享可持续的职场活力习惯。', category: '健康生活', author: '林晓', status: '已发布', views: 3280, likes: 186, color: '#2A56DE' },
