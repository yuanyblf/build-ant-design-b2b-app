...
const courses: Course[] = [
  { id: 1, title: '高效沟通与跨部门协作', summary: '通过真实协作案例掌握倾听、反馈和冲突处理方法。', category: '通用能力', lecturer: '林晓', status: '已发布', learners: 328, lessons: 8, progress: 76, color: '#2A56DE' },
...
function CourseList({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return <div className="page-stack">
    ...
    <Card><div className="table-toolbar"><Space><Button onClick={() => message.info('已进入批量分类模式')}>批量调整分类</Button><Button type="primary" icon={<PlusOutlined />} onClick={() => onNavigate('training-course-create')}>新建课程</Button></Space></div>
