...
function CourseList({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return <div className="page-stack">
    ...
    <SearchPanel fieldCount={4} onSearch={() => message.success(`找到 ${filtered.length} 门课程`)} onReset={() => { setKeyword(''); setCategory(undefined); setStatus(undefined); }}>
